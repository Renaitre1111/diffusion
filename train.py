...
from semilearn.imb_algorithms.dawn import DAWN


def get_config():
    from semilearn.algorithms.utils import str2bool

    parser = argparse.ArgumentParser(description="Noised Semi-Supervised Long-Tailed Learning")
    ...
    parser.add_argument("--uratio", type=int, default=1, help="the ratio of unlabeled data to labeled data in each mini-batch")
    parser.add_argument("--eval_batch_size", type=int, default=16, help="batch size of evaluation data loader")
    ...
    parser.add_argument("--include_lb_to_ulb", type=str2bool, default="True", help="flag of including labeled data into unlabeled data")

    ## imbalanced setting arguments
    parser.add_argument('-nl', '--num_labels', type=int, default=None)
    parser.add_argument('-unl', '--ulb_num_labels', type=int, default=None)
    parser.add_argument('--lb_imb_type', type=str, default='exp', help="imbalance type of labeled data")
    parser.add_argument("--lb_imb_ratio", type=int, default=1, help="imbalance ratio of labeled data")
    parser.add_argument('--ulb_imb_type', type=str, default='exp', help="imbalance type of unlabeled data")
    parser.add_argument("--ulb_imb_ratio", type=int, default=1, help="imbalance ratio of unlabeled data")
    parser.add_argument('--num_steps', type=int, default=5, help="number of steps for imbalance data generation")
    parser.add_argument("--noise_type", type=str, default='asym')
    parser.add_argument("--noise_ratio", type=int, default=0.0)
    parser.add_argument("--noise_per_class", type=str2bool, default=False)
    ...
    parser.add_argument("--multiprocessing-distributed", type=str2bool, default=False, help="use multi-processing distributed training")
...
def main(args):
    ...
    assert (args.num_train_iter % args.epoch == 0), f"# total training iter. {args.num_train_iter} is not divisible by # epochs {args.epoch}"  # noqa: E501
